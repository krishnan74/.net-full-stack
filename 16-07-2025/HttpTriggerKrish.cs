...
public class HttpTriggerKrish
{
    private readonly ILogger<HttpTriggerKrish> _logger;

    public HttpTriggerKrish(ILogger<HttpTriggerKrish> logger)
    {
        _logger = logger;
    }

    [Function("HttpTriggerKrish")]
