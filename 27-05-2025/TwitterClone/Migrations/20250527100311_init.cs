    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_hash_tag_tweets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_hash_tag_tweets_hash_tags_HashTagId",
                        column: x => x.HashTagId,
                        principalTable: "hash_tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_hash_tag_tweets_tweets_TweetId",
                        column: x => x.TweetId,
                        principalTable: "tweets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_hash_tag_tweets_HashTagId",
                table: "hash_tag_tweets",
                column: "HashTagId");

            migrationBuilder.CreateIndex(
                name: "IX_hash_tag_tweets_TweetId",
                table: "hash_tag_tweets",
                column: "TweetId");
