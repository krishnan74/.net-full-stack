...
SELECT setval(pg_get_serial_sequence('"quizSubmissions"', 'Id'), 1, false);
SELECT setval(pg_get_serial_sequence('"quizQuestions"', 'Id'), 1, false);
SELECT setval(pg_get_serial_sequence('questions', 'Id'), 1, false);
SELECT setval(pg_get_serial_sequence('quizzes', 'Id'), 1, false);
...
SELECT setval(pg_get_serial_sequence('"classSubjects"', 'Id'), 1, false);
SELECT setval(pg_get_serial_sequence('"teacherSubjects"', 'Id'), 1, false);
SELECT setval(pg_get_serial_sequence('"teacherClasses"', 'Id'), 1, false);

-- =====================
-- 1. INSERT CLASSES
-- =====================
INSERT INTO classes ("Name", "CreatedAt", "IsDeleted") VALUES
('Grade 10A', '2025-01-01', false),
('Grade 10B', '2025-01-01', false),
('Grade 11A', '2025-01-01', false),
('Grade 11B', '2025-01-01', false),
('Grade 12A', '2025-01-01', false);

-- =====================
-- 2. INSERT SUBJECTS
-- =====================
INSERT INTO subjects ("Code", "Name", "CreatedAt", "IsDeleted") VALUES
('MATH', 'Mathematics', '2025-01-01', false),
('SCI', 'Science', '2025-01-01', false),
('HIST', 'History', '2025-01-01', false),
('ENG', 'English', '2025-01-01', false),
('CS', 'Computer Science', '2025-01-01', false);
...
-- 4. INSERT TEACHERS
-- =====================
INSERT INTO teachers ("Email", "FirstName", "LastName", "IsDeleted", "CreatedAt") VALUES
('john.smith@school.edu', 'John', 'Smith', false, '2025-01-15 09:00:00'),
('sarah.johnson@school.edu', 'Sarah', 'Johnson', false, '2025-01-16 10:30:00'),
('michael.brown@school.edu', 'Michael', 'Brown', false, '2025-01-17 11:15:00'),
('emily.davis@school.edu', 'Emily', 'Davis', false, '2025-01-18 14:20:00'),
('david.wilson@school.edu', 'David', 'Wilson', false, '2025-01-19 16:45:00');

-- =====================
-- 5. INSERT STUDENTS
-- =====================
INSERT INTO students ("Email", "FirstName", "LastName", "ClassId", "IsDeleted", "CreatedAt") VALUES
('alice.student@school.edu', 'Alice', 'Anderson', 1, false, '2025-01-20 08:00:00'),
('bob.student@school.edu', 'Bob', 'Baker', 1, false, '2025-01-20 08:05:00'),
('carol.student@school.edu', 'Carol', 'Clark', 2, false, '2025-01-20 08:10:00'),
('dave.student@school.edu', 'Dave', 'Davis', 2, false, '2025-01-20 08:15:00'),
('eve.student@school.edu', 'Eve', 'Evans', 3, false, '2025-01-20 08:20:00'),
('frank.student@school.edu', 'Frank', 'Fisher', 3, false, '2025-01-20 08:25:00'),
('grace.student@school.edu', 'Grace', 'Garcia', 4, false, '2025-01-20 08:30:00'),
('henry.student@school.edu', 'Henry', 'Harris', 4, false, '2025-01-20 08:35:00'),
('iris.student@school.edu', 'Iris', 'Irwin', 5, false, '2025-01-20 08:40:00'),
('jack.student@school.edu', 'Jack', 'Jackson', 5, false, '2025-01-20 08:45:00');

-- =====================
-- 6. INSERT CLASS-SUBJECT RELATIONSHIPS
-- =====================
...
-- =====================
-- 7. INSERT TEACHER-SUBJECT RELATIONSHIPS
-- =====================
...
-- =====================
-- 8. INSERT TEACHER-CLASS RELATIONSHIPS
-- =====================
...
-- 9. INSERT QUIZZES
-- =====================
INSERT INTO quizzes ("Title", "Description", "TeacherId", "ClassId", "SubjectId", "CreatedAt", "DueDate", "IsActive", "IsDeleted") VALUES
('Algebra Basics', 'Introduction to algebraic expressions and equations', 1, 1, 1, '2025-02-01 09:00:00', '2025-02-15 23:59:59', true, false),
('Geometry Fundamentals', 'Basic geometric shapes and properties', 1, 1, 1, '2025-02-10 10:00:00', '2025-02-25 23:59:59', true, false),
('Calculus Introduction', 'Limits and derivatives basics', 1, 1, 1, '2025-03-01 11:00:00', '2025-03-15 23:59:59', false, false),
('Chemistry Basics', 'Introduction to atoms and molecules', 2, 3, 2, '2025-02-05 14:00:00', '2025-02-20 23:59:59', true, false),
('Physics Fundamentals', 'Basic physics concepts and formulas', 2, 3, 2, '2025-02-15 15:00:00', '2025-03-01 23:59:59', true, false),
('Biology Essentials', 'Cell structure and function', 2, 3, 2, '2025-03-05 16:00:00', '2025-03-20 23:59:59', true, false),
('Ancient Civilizations', 'Egypt, Greece, and Rome', 3, 2, 3, '2025-02-08 13:00:00', '2025-02-23 23:59:59', true, false),
('World War II', 'Major events and figures of WWII', 3, 2, 3, '2025-02-20 14:00:00', '2025-03-05 23:59:59', true, false),
('Shakespeare Literature', 'Hamlet and Macbeth analysis', 4, 4, 4, '2025-02-12 12:00:00', '2025-02-27 23:59:59', true, false),
('Grammar Fundamentals', 'Parts of speech and sentence structure', 4, 4, 4, '2025-03-02 13:00:00', '2025-03-17 23:59:59', true, false),
('Programming Basics', 'Introduction to programming concepts', 5, 5, 5, '2025-02-18 16:00:00', '2025-03-03 23:59:59', true, false),
('Database Design', 'SQL and database fundamentals', 5, 5, 5, '2025-03-08 17:00:00', '2025-03-23 23:59:59', true, false);
...
-- =====================
-- 11. INSERT QUIZ-QUESTION RELATIONSHIPS
-- =====================
...
-- =====================
-- 13. INSERT ANSWERS (Sample answers for Submitted submissions)
-- =====================
