...
namespace FirstAPI.Controllers
{
    ...
    public class AppointmentController : ControllerBase
    {
        ...
        public async Task<ActionResult<Appointment>> CancelAppointment(string appointmentNumber, int doctorId)
        {
            try
            {
                var cancelledAppointment = await _appointmentService.CancelAppointment(appointmentNumber, doctorId);
