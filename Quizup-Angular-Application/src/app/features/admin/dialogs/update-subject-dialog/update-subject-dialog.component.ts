...
@Component({
  selector: 'app-update-subject-dialog',
  templateUrl: './update-subject-dialog.component.html',
  styleUrls: ['./update-subject-dialog.component.css'],
  imports: [FormsModule, ReactiveFormsModule, CommonModule],
})
export class UpdateSubjectDialogComponent {
  availableSubjects: SubjectModel[] = [];
  classForm: FormGroup;

  constructor(
    public dialogRef: MatDialogRef<UpdateSubjectDialogComponent>,
